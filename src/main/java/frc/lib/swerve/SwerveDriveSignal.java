 ...
 * We use a class like this to hold all the important features when the robot is
 * driving,
 * these values include the driving orientation of the robot, whether it is open
 * loop, and if the wheels need to be locked.
 * There should only be one instance of this class 'attatched' to the swerve
 * subsystem and it should
