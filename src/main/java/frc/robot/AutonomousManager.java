...
public class AutonomousManager {
    ...
    public AutonomousManager(RobotContainer container) {
        ...
        //                 .asProxy());
        // scheduled because we dont want stop points to stop them
        // eventMap.put(
        //         "liftToHighCube",
        ...
        //                         && (armSubsystem.getState() == ArmState.AWAITING_DEPLOYMENT
        //                                 || armSubsystem.getState() == ArmState.COOL_HANDOFF_REVERSE))
        //                 .andThen(armSubsystem.highManualCubeCommand())
        //                 .asProxy()
        //                 .unless(() -> !gripperSubsystem.hasGamePiece())
        //                 .asProxy());
        // eventMap.put(
        ...
        //                                 armSubsystem.armStateCommand(ArmState.HIGH_MANUAL_CUBE),
        //                                 armSubsystem.highManualCubeCommand(),
        ...
        //                         && (armSubsystem.getState() == ArmState.AWAITING_DEPLOYMENT
        //                                 || armSubsystem.getState() == ArmState.COOL_HANDOFF_REVERSE))
        //                 .andThen(armSubsystem.midManualCubeCommand())
        //                 .asProxy()
        //                 .unless(() -> !gripperSubsystem.hasGamePiece())
        //                 .asProxy());
        // eventMap.put(
        ...
        //                                 || armSubsystem.getState() == ArmState.COOL_HANDOFF_REVERSE))
        //                 .andThen(Commands.either(
        //                                 armSubsystem.armStateCommand(ArmState.MID_MANUAL_CUBE),
        //                                 armSubsystem.midManualCubeCommand(),
        ...
        // eventMap.put(
        //         "ejectHybrid",
        //         waitUntil(() -> armSubsystem.isArmApproximatelyAtGoal()
        //                         && armSubsystem.getState() == ArmState.AWAITING_DEPLOYMENT)
        //                 .andThen(gripperSubsystem
        //                         .ejectFastFromGripperCommand()
        //                         .alongWith(armSubsystem.armStateCommand(ArmState.SHOOT_HYBRID)))
        //                 .withTimeout(0.5)
        //                 .asProxy());
        // eventMap.put(
        //         "throwHybrid",
        ...
        //                 .andThen(gripperSubsystem
        //                         .ejectFromGripperCommand()
        //                         .alongWith(armSubsystem.armHandoffStateCommand(ArmState.SHOOT_HYBRID)))
        //                 .withTimeout(0.5)
        //                 .asProxy());
        // eventMap.put(
        //         "immediateEjectHybrid",
        //         gripperSubsystem.ejectFromGripperCommand().withTimeout(0.5).asProxy());
        // eventMap.put(
        //         "handoff",
        //         armSubsystem
        //                 .handoffCommand()
    ...
    private enum AutonomousOption {
        ...
        OPEN_PLACE3HANDOFF(
                ...
                StartingLocation.OPEN, 3, false /*not yet ;)*/, "open_place3handoff", new PathConstraints(3.3, 3.0)),
        ...
        public List<PathPlannerTrajectory> getPath() {
            // Lazy load the path
            //if (path == null) path = PathPlannerPath.loadPathGroup(pathName, constraint, constraints);
