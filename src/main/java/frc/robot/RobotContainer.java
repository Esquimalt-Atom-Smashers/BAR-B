...
/* Set default commands */
swerveDriveSubsystem.setDefaultCommand(swerveDriveSubsystem.driveCommand(
      this::getDriveForwardAxis, this::getDriveStrafeAxis, this::getDriveRotationAxis, false));
...
//leftDriveController.nameLeftBumper("Level Charge Station");
...
//rightDriveController.getDPadRight().whileTrue(armSubsystem.overrideGripper(3));
